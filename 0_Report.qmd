...
Example of data analysis with categorical data. In this case using randomly regenerated M&A deals with a few attributes : sectors, regions, dealsize. Basic exploratory data analysis.
:::
...
```{r}
## Density of dealsize per sector
m <-
evolution %>%
