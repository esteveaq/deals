...
::: callout-note
## Fictional use case
Example of data analysis with categorical data. In this case randomly regenerated M&A deals with a few attributes : sectors, regions, deal size. Basic exploratory data analysis.
:::
